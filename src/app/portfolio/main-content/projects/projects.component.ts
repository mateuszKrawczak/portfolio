...
export class ProjectsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.projects[1]={name:"Easy quisy",description:"This is a quiz app which helps you check your real knowledge. Quiz has six categories with three difficulty levels with really tough questions.",photos:["EQ_home_screen.png","EQ_kategorie_screen.png","EQ_pytanie_screen.png"],link:"https://github.com/mateuszKrawczak/EducationalApp"};
